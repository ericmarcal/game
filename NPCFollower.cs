...
public class NPCFollower : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (rb == null) Debug.LogWarning($"NPCFollower em {gameObject.name} não tem Rigidbody2D!", this); // Mantido como Warning
        ...
        // else Debug.LogError($"NPCFollower: Objeto Player com tag '{playerTag}' NÃO encontrado!", this); // Removido
    }
