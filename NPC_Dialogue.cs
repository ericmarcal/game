...
public class NPC_Dialogue : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (dialogue == null) Debug.LogWarning($"NPC_Dialogue em {gameObject.name} não tem DialogueSettings atribuído.", this); // Mantido como Warning
        if (speechBubblePrefab == null) Debug.LogWarning($"NPC_Dialogue em {gameObject.name} não tem SpeechBubblePrefab atribuído.", this); // Mantido como Warning
    }
    ...
    private void ShowNextBubble()
    {
        ...
        {
            // Debug.LogError("Prefab do balão não tem TextMeshPro ou SpriteRenderer!", this); // Removido
            HideBubble(); return;
        }
    ...
    private void LoadDialogue()
    {
        ...
        {
            // Debug.LogWarning($"DialogueControl instance não encontrada. Carregando em Português por padrão.", this); // Removido
